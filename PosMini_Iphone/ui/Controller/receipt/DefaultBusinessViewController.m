...
-(void)viewDidAppear:(BOOL)animated{
    ...
    //故障对应#0002506
    //更新商户名称
    if ([PosMiniDevice sharedInstance].simpeName == nil &&
        [[PosMiniDevice sharedInstance].simpeName isEqualToString:@""])
    {
        _businessNameLabel.text=[Helper getValueByKey:POSMINI_LOGIN_USERNAME];
    }
    else
    {
        _businessNameLabel.text=[PosMiniDevice sharedInstance].simpeName;
    }
}
